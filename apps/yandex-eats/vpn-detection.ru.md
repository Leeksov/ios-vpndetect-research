...
Стандартная Yandex AppLib реализация — идентична той, что в Я.Маркете и Кинопоиске. См. [yandex-market/vpn-detection.md](../yandex-market/vpn-detection.ru.md#детектор-1----yalafhttpclient-isvpnconnected) для деталей.
